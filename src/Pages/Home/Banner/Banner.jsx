            ...
            <div id="slide1" className="carousel-item relative w-full ">
                ...
                <div className="absolute rounded-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#0f0f0f] to-[rgba(21, 21, 21, 0)]">
                    <div className="text-white space-y-7 pl-12 w-1/2">
                        ...
                        <div>
                            <button className="btn btn-error mr-5 btn-xs md:btn-md">Discover More</button>
                            <button className="btn btn-secondary btn-xs md:btn-md btn-outline mr-5"><span className="text-white">Latest Project</span></button>
                        </div>
                    </div>
                </div>
